...
qualified_name: backend.tests.test_allmail.test_all_scope_kind_filters
...
# test_all_scope_kind_filters

> Auto-generated from source code. Do not manually edit this file; update source code or generator instead.

## Purpose

Purpose inferred from usage: `test_all_scope_kind_filters` in `backend/tests/test_allmail.py`.

## Location

`backend/tests/test_allmail.py:69`
