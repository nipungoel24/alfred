...
qualified_name: backend.tests.test_gmail_mock.test_gmail_sync_history_expired_recovery
...
# test_gmail_sync_history_expired_recovery

> Auto-generated from source code. Do not manually edit this file; update source code or generator instead.

## Purpose

Purpose inferred from usage: `test_gmail_sync_history_expired_recovery` in `backend/tests/test_gmail_mock.py`.

## Location

`backend/tests/test_gmail_mock.py:239`
