...
qualified_name: backend.tests.test_task_derivation.test_derive_tasks_ignores_noise
...
# test_derive_tasks_ignores_noise

> Auto-generated from source code. Do not manually edit this file; update source code or generator instead.

## Purpose

Purpose inferred from usage: `test_derive_tasks_ignores_noise` in `backend/tests/test_task_derivation.py`.

## Location

`backend/tests/test_task_derivation.py:15`
