...
qualified_name: backend.tests.test_allmail.test_all_scope_includes_archived
...
# test_all_scope_includes_archived

> Auto-generated from source code. Do not manually edit this file; update source code or generator instead.

## Purpose

Purpose inferred from usage: `test_all_scope_includes_archived` in `backend/tests/test_allmail.py`.

## Location

`backend/tests/test_allmail.py:48`
