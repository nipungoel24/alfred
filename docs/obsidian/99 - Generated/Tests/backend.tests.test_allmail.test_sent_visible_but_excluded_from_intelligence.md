...
qualified_name: backend.tests.test_allmail.test_sent_visible_but_excluded_from_intelligence
...
# test_sent_visible_but_excluded_from_intelligence

> Auto-generated from source code. Do not manually edit this file; update source code or generator instead.

## Purpose

Purpose inferred from usage: `test_sent_visible_but_excluded_from_intelligence` in `backend/tests/test_allmail.py`.

## Location

`backend/tests/test_allmail.py:78`
