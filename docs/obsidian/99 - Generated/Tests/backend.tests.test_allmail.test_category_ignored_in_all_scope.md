...
qualified_name: backend.tests.test_allmail.test_category_ignored_in_all_scope
...
# test_category_ignored_in_all_scope

> Auto-generated from source code. Do not manually edit this file; update source code or generator instead.

## Purpose

Purpose inferred from usage: `test_category_ignored_in_all_scope` in `backend/tests/test_allmail.py`.

## Location

`backend/tests/test_allmail.py:100`
