...
qualified_name: backend.tests.test_eligibility.test_archived_state
...
Purpose inferred from usage: `test_archived_state` in `backend/tests/test_eligibility.py`.

## Location

`backend/tests/test_eligibility.py:74`
