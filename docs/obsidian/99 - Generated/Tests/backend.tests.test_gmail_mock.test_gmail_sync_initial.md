...
qualified_name: backend.tests.test_gmail_mock.test_gmail_sync_initial
...
# test_gmail_sync_initial

> Auto-generated from source code. Do not manually edit this file; update source code or generator instead.

## Purpose

Purpose inferred from usage: `test_gmail_sync_initial` in `backend/tests/test_gmail_mock.py`.

## Location

`backend/tests/test_gmail_mock.py:57`
